...
const addVehicle2 = async (brand_name, model_name, price, model_year, mileage, power_type, gearbox_type) => {
    try {
...
module.exports = { addVehicle2, getVehicleById, deleteVehicle, updateVehicle, searchVehicles};